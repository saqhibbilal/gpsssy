...
export default function Settings() {
  ...
  return (
    <div className="overflow-y-auto h-screen">
      <div className="px-4 py-6 min-h-[150vh]">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1">
          ...
          <div className="flex-1">
            {/* Account Settings */}
            <TabsContent value="account" className="h-full overflow-y-auto pr-2">
              <Card>
                <CardHeader>
            ...
            <TabsContent value="notifications" className="h-full overflow-y-auto pr-2">
              <Card>
                <CardHeader>
            ...
            {/* Map Settings */}
            <TabsContent value="map" className="h-full overflow-y-auto pr-2">
              <Card>
                <CardHeader>
            ...
            {/* System Settings */}
            <TabsContent value="system" className="h-full overflow-y-auto pr-2">
              <Card>
                <CardHeader>
